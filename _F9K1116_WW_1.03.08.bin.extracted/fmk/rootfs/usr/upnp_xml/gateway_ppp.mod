...
<root xmlns="urn:schemas-upnp-org:device-1-0">
	...
	<friendlyName>Belkin N Wireless Gateway</friendlyName>
	<manufacturer>Belkin International, Inc.</manufacturer>
	<manufacturerURL>http://www.Belkin.com</manufacturerURL>
	<modelDescription>Wireless Gateway with Ethernet Switch</modelDescription>
	<modelName>N Wireless Gateway</modelName>
